...
class Calendars {
  ...
  _getCalendarRootNodeResponse(owner, children) {
    var response = "";
  ...
  _returnPropfindElements(owner, calendar, children, callback) {
    var response = "";
  ...
  _returnCalendar(owner, calendar, children) {
    var response = "";
    ...
    response += this._returnPropfindElements(owner, calendar, children);
  ...
  propfind(xmlDoc) {
    ...
    response += "<d:multistatus xmlns:d=\"DAV:\" xmlns:cal=\"urn:ietf:params:xml:ns:caldav\" xmlns:cs=\"http://calendarserver.org/ns/\" xmlns:card=\"urn:ietf:params:xml:ns:carddav\">";
    response += this._getCalendarRootNodeResponse("USERNAME", children);
    ...
    calendars.forEach(c => {
      ...
      response += this._returnCalendar("USERNAME", c, children);
    });
    response += "</d:multistatus>";
    return response;
  };
